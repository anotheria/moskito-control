...
public class MoSKitoControlMappingsConfigurator implements ActionMappingsConfigurator {
	...
	public void configureActionMappings(ActionMappings actionMappings) {
		...
		actionMappings.addMapping("qrCodePage", ShowQRCodeAction.class,
				new CommandForward("success", "/org/moskito/control/ui/jsp/QRCode.jsp")
		);

		actionMappings.addMapping("generateQRCode", GenerateQRCodeAction.class);
